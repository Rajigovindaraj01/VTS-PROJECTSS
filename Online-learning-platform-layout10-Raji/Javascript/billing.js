...
document.addEventListener("DOMContentLoaded", () => {
    const data = localStorage.getItem("learning-website-details");
    if (!data) {
      alert("No course data found!");
      return;
    }
    const course = JSON.parse(data);
    console.log("Loaded course from localStorage:", course);
    document.getElementById("originalPrice").innerText = course.originalPrice;
    document.getElementById("discountAmount").innerText = course.discountAmount;
    document.getElementById("finalPrice").innerText = course.finalAmount;
    document.getElementById("payAmount").innerText = course.finalAmount.replace("Rs.", "");
  });
// ----------------navi to next----------------------------------------------------------------------------------------------------------------

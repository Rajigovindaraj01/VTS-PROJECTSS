...
document.getElementById("checkoutBtn").addEventListener("click", function () {
    const originalPrice = 10447;
    const discountPercent = 83;

    const discountAmount = Math.round((discountPercent / 100) * originalPrice);
    const finalAmount = originalPrice - discountAmount;

    const courseDetails = {
      title: document.querySelector(".d1").innerText,
      description: document.querySelector(".d2").innerText,
    ...
    localStorage.setItem("learning-website-details", JSON.stringify(courseDetails));

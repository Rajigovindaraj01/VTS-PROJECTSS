...
// -------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  function handleAddToCart() {
    const course = {
      title: "Data Analyst",
      description: "Kickstart your career in data with our intensive, job-ready program.",
      price: 1737,
      originalPrice: 10447,
      rating: 4.5,
      exercises: 121,
    ...
    const cart = getCart();
    const exists = cart.some(item => item.title === course.title);
    if (!exists) {
      cart.push(course);
      localStorage.setItem("learning-website-cart", JSON.stringify(cart));
...
//checkout navigation
 document.addEventListener("DOMContentLoaded", function () {
    ...
    checkoutBtn.addEventListener("click", function () {
      const courseDetails = {
        title: "Data Analyst Career Accelerator",
        description:
          "Kickstart your career in data with our intensive, job-ready program. Learn data analysis, visualization, SQL, Python and real-world business insights.",
        originalPrice: 10447,
        offerPrice: 1737,
        image: "../Assets/Images/financial.png",
      };
      localStorage.setItem("final-learning-details", JSON.stringify(courseDetails));

...
//retrieve
  const userData = JSON.parse(localStorage.getItem("pet-user-buynow"));

  if (userData) {
    document.querySelectorAll(".ss1 div:nth-child(2)")[0].innerText = 
      userData.firstName + " " + userData.lastName;
    document.querySelectorAll(".ss1 div:nth-child(2)")[1].innerText = 
      userData.address + ", " + userData.apartment + ", " + userData.city + ", " + userData.state + " - " + userData.pincode;
    document.querySelectorAll(".ss1 div:nth-child(2)")[2].innerText = userData.phone;
    document.querySelectorAll(".ss1 div:nth-child(2)")[3].innerText = userData.email;
  }
